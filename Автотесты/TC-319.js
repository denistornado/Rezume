...
// I.click(locate('h6').withText('Главная'));
  I.click(locate('.navigation-link').at(5));
  I.click(locate('.p-button').at(2));
  I.fillField(locate('.p-inputtext').at(1),'ТЕСТ');
  I.click(locate('.p-field-checkbox').at(1));
  I.click(locate('.p-component').at(1));
